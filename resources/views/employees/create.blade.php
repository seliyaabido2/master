    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('employees.index') }}">Admin Users</a>
                </li>
            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-body">
                        ...
                        {!! Form::open(array("route" => array('employees.store'), 'method' => 'POST','id'=>'create_employee_user','autocomplete' =>'off','enctype'=>'multipart/form-data' )) !!}
                            @include('employees.form',['form'=>'Create'])
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
