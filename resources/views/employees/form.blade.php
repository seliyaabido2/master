<div class="row">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="hidden" name="id" value="{{ isset($employer) ? $employer->id : null }}">
        {!! Form::text('first_name', null, ['placeholder' => 'First Name', 'class' => 'form-control', 'id' => 'first_name', 'required' => true]) !!}
    </div>

    <!-- Last Name -->
    <div class="form-group col-md-6">
        <label class="form-control-label">Last Name<span class="vali">*</span></label>
        {!! Form::text('last_name', null, ['placeholder' => 'Last Name', 'class' => 'form-control', 'id' => 'last_name', 'required' => true]) !!}
    </div>

    <!-- Email -->
    <div class="form-group col-md-6">
        <label class="form-control-label">Email<span class="vali">*</span></label>
        {!! Form::email('email', null, ['placeholder' => 'Email', 'class' => 'form-control', 'id' => 'email', 'required' => true]) !!}
    </div>

    <!-- Country Code -->
    <div class="form-group col-md-6">
        <label class="form-control-label">Country Code<span class="vali">*</span></label>
        {!! Form::text('country_code', null, ['placeholder' => 'Country Code', 'class' => 'form-control', 'id' => 'country_code', 'required' => true]) !!}
    </div>

    <!-- Mobile -->
    <div class="form-group col-md-6">
        <label class="form-control-label">Mobile<span class="vali">*</span></label>
        {!! Form::text('mobile', null, ['placeholder' => 'Mobile', 'class' => 'form-control', 'id' => 'mobile', 'required' => true]) !!}
    </div>
   
    <!-- Address -->
    <div class="form-group col-md-6">
        <label class="form-control-label">Address<span class="vali">*</span></label>
        {!! Form::textarea('address', null, ['placeholder' => 'Address', 'class' => 'form-control', 'id' => 'address', 'rows' => 3, 'required' => true]) !!}
    </div>

    <!-- Gender -->
    <div class="form-group col-md-6">
        <label class="form-control-label">Gender<span class="vali">*</span></label>
        {!! Form::select('gender', ['Male' => 'Male', 'Female' => 'Female', 'Other' => 'Other'], null, ['placeholder' => 'Select Gender', 'class' => 'form-control', 'id' => 'gender', 'required' => true]) !!}
    </div>
